"""
* This file is copied from https://github.com/keiichishima/pcalg/blob/480d833a1f18da14d5f7b2ea9c7b61e25e21a0b1/pcalg.py and modified a part of it. *
Author: Keiichi SHIMA / Internet Initiative Japan Inc. / WIDE project
...
def estimate_cpdag(skel_graph, sep_set):
    ...
    def _has_one_edge(dag, i, j):
        return (dag.has_edge(i, j) and (not dag.has_edge(j, i))) or (not dag.has_edge(i, j)) and dag.has_edge(j, i)
