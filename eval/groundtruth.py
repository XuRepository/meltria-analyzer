    ...
    "pod-memory-hog": {
        ...
        ("*", "mongodb"): {
            ...
            "optional": [
                ...
                "mongodb_ss_tcmalloc_pageheap_commit_count",
                "mongodb_ss_tcmalloc_pageheap_committed_bytes",
                "mongodb_ss_tcmalloc_pageheap_free_bytes",
                "mongodb_ss_tcmalloc_pageheap_reserve_count",
                "mongodb_ss_tcmalloc_pageheap_scavenge_count",
                "mongodb_ss_tcmalloc_pageheap_total_commit_bytes",
                "mongodb_ss_tcmalloc_pageheap_total_decommit_bytes",
                "mongodb_ss_tcmalloc_pageheap_total_reserve_bytes",
                "mongodb_ss_tcmalloc_pageheap_unmapped_bytes",
            ],
        },
    },
    "pod-network-loss": {
