...
from diagnoser.daggnn.utils import preprocess_adj_new, preprocess_adj_new1
...
class SEMEncoder(nn.Module):
    ...
    def __init__(self, n_in, n_hid, n_out, adj_A, batch_size, do_prob=0.0, factor=True, tol=0.1):
